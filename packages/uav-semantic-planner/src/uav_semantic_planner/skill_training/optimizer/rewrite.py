...
from uav_semantic_planner.skill_training.optimizer.update_modes import get_payload_items
    ...
    *,
    ...
    try:
        ...
        if result and str(result.get("new_skill", "")).strip():
            ...
            if "change_summary" not in result or not isinstance(
                result["change_summary"], list
            ):
