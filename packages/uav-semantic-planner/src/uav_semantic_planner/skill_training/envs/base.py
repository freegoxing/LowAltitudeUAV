...
from uav_semantic_planner.skill_training.datasets.base import BaseDataLoader, BatchSpec
...
class EnvAdapter(ABC):
    ...
    def select_representative_items(
        ...
        *,
        ...
        selected.extend(
            item
            for item in _pick(successes, n_successes)
    ...
    def build_env_from_batch(self, batch: BatchSpec, **kwargs):
        ...
        if batch.phase == "train":
            return self.build_train_env(
                batch_size=batch.batch_size, seed=batch.seed, **kwargs
            )
    ...
    def reflect(
        ...
        **kwargs,
        ...
        """
        from uav_semantic_planner.skill_training.gradient.reflect import (
