...
def main():
    ...
    candidate_group_ids, candidate_features = candidate_group_features(
        kg_data, int_id_to_raw_id
    )
    candidate_group_features_by_type = {
        node_type: candidate_features[indices]
        for node_type, indices in x_dict_ids.items()
    }
    ...
    checkpoint_data = {
        ...
        "candidate_group_features_by_type": candidate_group_features_by_type,
    }
